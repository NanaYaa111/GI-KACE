...
#General function structure with return
def function_name2():
    #function_action
    return "What the function is to give as output"
...
print('Greet 3 function')

print(greet3("Hey there, this is python"))

##Write a function to create a user profile
def create_user_profile(username, email, age):
    ...
    return user_profile
print(create_user_profile("miracle123", "miracle123@example.com", 25)) 
...
def user_profile_input():
    ...
    return create_user_profile(username, email, age)
print(user_profile_input())

def ghana_card(height, age, ghana_card_number, nation="Ghana"):
   return f"""
    Your Ghana Card Details:
    Card Number: {ghana_card_number}
    Height: {height} cm
    Age: {age}
    Nationality: {nation}
    """
print(ghana_card(170, 25, "GHA1234567890"))

#Functions are used to encapsulate a block of code that performs a 
# specific task.
# Functions help to organize code, make it reusable, 
...
# Parameters are specified within the parentheses in the
#  function definition.
# Return values are specified using the return keyword.
# Functions can be called (invoked) by using the function name
...
# print("The sum of adding this two numbers is: ", result)


# def chelsy(hair_color, eye_color):
#     return f"Chelsy has {hair_color} hair and {eye_color} eyes."
# print(chelsy('brown', 'sea blue'))


# def sportybet_king(username, password):
#     return f"Welcome {username} to Sportybet King. Your password is {password}."
# print(sportybet_king('Arnold', 'bet3dimisaaaaa'))


# def user_profile(name, age, email):
#     profile = {
#         'name': name,
#         'age': age,
#         'email': email
#     }
#     return profile
# user_input = input("Enter your name, age, and email separated by commas: ")
# print(user_input)
# name, age, email = user_input.split(',')
# print(user_profile(name, age, email))
